<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于web的网络在线考试系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.zhunkaozhenghao" class="input" type="text" placeholder="准考证号">
			   </div>
			 </div> -->
			<el-form-item label="准考证号" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.zhunkaozhenghao" autocomplete="off" placeholder="准考证号"  />
			</el-form-item>
