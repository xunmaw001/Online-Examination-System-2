<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="准考证号" prop="zhunkaozhenghao">
          <el-input v-model="ruleForm.zhunkaozhenghao" 
              placeholder="准考证号" clearable  :readonly="ro.zhunkaozhenghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="准考证号" prop="zhunkaozhenghao">
              <el-input v-model="ruleForm.zhunkaozhenghao" 
                placeholder="准考证号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dianhuahaoma = true;
          ...
          if(o=='zhunkaozhenghao'){
            this.ruleForm.zhunkaozhenghao = obj[o];
	    this.ro.zhunkaozhenghao = true;
            continue;
          }
        }
      }
